#ifndef _ROS_my_msgs_Battery_h
#define _ROS_my_msgs_Battery_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
namespace riki_msgs
{
  ...
  class Battery : public ros::Msg
  {
    ...
    virtual const char * getType(){ return "riki_msgs/Battery"; };
    virtual const char * getMD5(){ return "da7225c3562dd2b9b88bf15aa7eb6a9e"; };
